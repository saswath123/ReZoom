...
def upload_resume():
    try:
        ...
        # ============================================================
        # ✅ ADD THIS BLOCK - Convert PNG to Base64
        # ============================================================
        ...
        # ============================================================
        # ✅ MODIFY THIS RETURN STATEMENT - Add image_base64
        # ============================================================
        return jsonify({
            "success": True,
            "message": "Resume processed successfully",
            "data": structured_data,
            "image_base64": image_base64,  # ✅ ADD THIS LINE
            "image_download_url": f"/download/{png_filename}",  # Keep for backward compatibility
